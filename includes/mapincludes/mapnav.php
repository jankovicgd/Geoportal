      ...
      <ul class="dropdown-menu">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <ul class="dropdown-menu">
              <li><a href="#" onclick="prikazModalWFS()" data-toggle="modal" data-target="#modalWFS" class="WFS" data-ext="GML3">GML</a></li>
              <li><a href="#" onclick="prikazModalWFS()" data-toggle="modal" data-target="#modalWFS" class="WFS" data-ext="shape-zip">SHP</a></li>
            </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#" onclick="prikazModalWMS()" data-toggle="modal" data-target="#modalWMS" class="WMS" data-ext="pdf">PDF</a></li>
